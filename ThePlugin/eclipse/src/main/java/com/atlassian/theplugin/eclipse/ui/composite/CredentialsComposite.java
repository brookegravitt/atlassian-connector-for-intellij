...
public class CredentialsComposite extends Composite {
	...
	private void createControls() {
		...
		authGroup.setText(Activator.getDefault().getResource("CredentialsComposite.Authentication"));
		...
		description.setText(Activator.getDefault().getResource("CredentialsComposite.User"));
		...
		data.horizontalIndent = 0;
		description.setLayoutData(data);
		description.setText(Activator.getDefault().getResource("CredentialsComposite.Password"));
		...
		this.savePassword.setText(Activator.getDefault().getResource("CredentialsComposite.SavePassword"));
