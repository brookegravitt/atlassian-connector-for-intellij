...
public interface RpcReviewServiceName {
    ...
    @RequestWrapper(localName = "removeReviewItem", targetNamespace = "http://rpc.spi.crucible.atlassian.com/", className = "com.atlassian.theplugin.crucible.api.soap.CrucibleSessionImpl.RemoveReviewItem")
