...
@WebServiceClient(name = "Review", targetNamespace = "http://rpc.spi.crucible.atlassian.com/", wsdlLocation = "file:/C:/Dev/ThePlugin/src/test/java/com/atlassian/theplugin/crucible/api/soap/xfire/review/review.wsdl")
public class Review extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Dev/ThePlugin/src/test/java/com/atlassian/theplugin/crucible/api/soap/xfire/review/review.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/C:/Dev/ThePlugin/src/test/java/com/atlassian/theplugin/crucible/api/soap/xfire/review/review.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
