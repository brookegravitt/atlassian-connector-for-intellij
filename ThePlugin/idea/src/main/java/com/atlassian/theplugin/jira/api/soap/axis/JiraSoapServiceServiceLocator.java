...
public class JiraSoapServiceServiceLocator extends org.apache.axis.client.Service implements com.atlassian.theplugin.jira.api.soap.axis.JiraSoapServiceService {
    ...
    public com.atlassian.theplugin.jira.api.soap.axis.JiraSoapService getJirasoapserviceV2(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.atlassian.theplugin.jira.api.soap.axis.JirasoapserviceV2SoapBindingStub _stub = new com.atlassian.theplugin.jira.api.soap.axis.JirasoapserviceV2SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.atlassian.theplugin.jira.api.soap.axis.JiraSoapService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.atlassian.theplugin.jira.api.soap.axis.JirasoapserviceV2SoapBindingStub _stub = new com.atlassian.theplugin.jira.api.soap.axis.JirasoapserviceV2SoapBindingStub(new java.net.URL(JirasoapserviceV2_address), this);
                _stub.setPortName(getJirasoapserviceV2WSDDServiceName());
                return _stub;
            }
        }
