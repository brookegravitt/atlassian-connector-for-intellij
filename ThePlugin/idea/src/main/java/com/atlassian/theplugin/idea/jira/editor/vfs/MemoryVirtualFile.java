...
public class MemoryVirtualFile extends DeprecatedVirtualFile {
     ...
     */
    public MemoryVirtualFile(@NotNull String name, String content) {
     ...
     */
    private MemoryVirtualFile(@NotNull String name, String content, boolean isDirectory) {
        this.name = name;
     ...
     */
    @Nullable
    public MemoryVirtualFile getChild(String filename) {
