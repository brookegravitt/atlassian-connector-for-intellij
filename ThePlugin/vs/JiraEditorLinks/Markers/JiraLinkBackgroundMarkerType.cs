...
{
    public sealed class JiraLinkBackgroundMarkerType : IVsPackageDefinedTextMarkerType, IVsMergeableUIItem, IVsHiColorItem
    {
        private const string JIRA_LINK_BACKGROUND = "JIRA Link (Background)";
        ...
        public int GetVisualStyle(out uint pdwVisualFlags)
        {
            ...
            pdwVisualFlags = (uint)(MARKERVISUAL.MV_COLOR_LINE_IF_NO_MARGIN | MARKERVISUAL.MV_GLYPH | MARKERVISUAL.MV_MULTILINE_GLYPH | MARKERVISUAL.MV_TIP_FOR_GLYPH);
        ...
        {
            pbstrNonLocalizeName = JIRA_LINK_BACKGROUND;
        ...
        public int GetDisplayName(out string pbstrDisplayName)
        {
            ...
            pbstrDisplayName = JIRA_LINK_BACKGROUND;
        ...
        {
            pbstrDesc = JIRA_LINK_BACKGROUND;
