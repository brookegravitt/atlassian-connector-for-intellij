...
public abstract class AbstractActionOperation implements IActionOperation {
	private final MultiStatus status = new MultiStatus(Activator.PLUGIN_ID, IStatus.OK, "", null);
	...
	protected void reportError(Throwable t) {
		...
		this.reportStatus(new Status(IStatus.ERROR, Activator.PLUGIN_ID, IStatus.OK, this.getShortErrorMessage(t), t));
	}
