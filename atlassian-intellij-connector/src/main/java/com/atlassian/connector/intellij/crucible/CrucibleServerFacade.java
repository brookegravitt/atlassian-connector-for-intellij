...
public interface CrucibleServerFacade extends ProductServerFacade {
	CrucibleVersionInfo getServerVersion(ServerData server)
...
//	ReviewAdapter createReviewFromPatch(ServerData server, Review review, String patch, PatchAnchorData anchorData) throws RemoteApiException,
//			ServerPasswordNotProvidedException;
