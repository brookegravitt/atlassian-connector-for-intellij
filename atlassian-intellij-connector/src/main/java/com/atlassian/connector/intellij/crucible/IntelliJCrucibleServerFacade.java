...
public final class IntelliJCrucibleServerFacade extends ConfigurationListenerAdapter implements CrucibleServerFacade {
	...
	public CrucibleVersionInfo getServerVersion(ServerData server)
			throws RemoteApiException, ServerPasswordNotProvidedException {
		return facade.getServerVersion(server);
	}
    ...
    public ReviewAdapter createReviewFromPatch(ServerData server, Review review, String patch) throws RemoteApiException,
	    ...
	    public ReviewAdapter createReviewFromPatch(ServerData server, Review review, String patch, PatchAnchorData anchorData) throws RemoteApiException,
            ServerPasswordNotProvidedException {
        return toReviewAdapter(facade.createReviewFromPatch(server, review, patch, anchorData), server);
    }
