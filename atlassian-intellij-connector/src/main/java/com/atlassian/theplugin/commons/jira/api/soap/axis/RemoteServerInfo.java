...
public class RemoteServerInfo implements java.io.Serializable {
	...
	private com.atlassian.theplugin.commons.jira.api.soap.axis.RemoteTimeInfo serverTime;
	...
	public RemoteServerInfo(
			...
			com.atlassian.theplugin.commons.jira.api.soap.axis.RemoteTimeInfo serverTime,
	 ...
	 * @return serverTime
	 */
	public com.atlassian.theplugin.commons.jira.api.soap.axis.RemoteTimeInfo getServerTime() {
		return serverTime;
	}
	 ...
	 * @param serverTime
	 */
	public void setServerTime(com.atlassian.theplugin.commons.jira.api.soap.axis.RemoteTimeInfo serverTime) {
		this.serverTime = serverTime;
	}
