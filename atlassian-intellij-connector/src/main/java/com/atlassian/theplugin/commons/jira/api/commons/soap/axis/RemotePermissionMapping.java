...
public class RemotePermissionMapping implements java.io.Serializable {
	private com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemotePermission permission;

	private com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteEntity[] remoteEntities;

	public RemotePermissionMapping() {
	}

	public RemotePermissionMapping(
			com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemotePermission permission,
			com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteEntity[] remoteEntities) {
	 ...
	 * @return permission
	 */
	public com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemotePermission getPermission() {
		return permission;
	}
	 ...
	 * @param permission
	 */
	public void setPermission(com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemotePermission permission) {
		this.permission = permission;
	}
	 ...
	 */
	public com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteEntity[] getRemoteEntities() {
		return remoteEntities;
	}
	 ...
	 */
	public void setRemoteEntities(com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteEntity[] remoteEntities) {
		this.remoteEntities = remoteEntities;
	}
