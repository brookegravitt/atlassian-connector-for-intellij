...
public class RemotePermissionScheme extends com.atlassian.theplugin.commons.jira.api.soap.axis.RemoteScheme
		implements java.io.Serializable {
	private com.atlassian.theplugin.commons.jira.api.soap.axis.RemotePermissionMapping[] permissionMappings;
	...
	public RemotePermissionScheme(
			...
			com.atlassian.theplugin.commons.jira.api.soap.axis.RemotePermissionMapping[] permissionMappings) {
		super(
				description,
				id,
				name,
	 ...
	 */
	public com.atlassian.theplugin.commons.jira.api.soap.axis.RemotePermissionMapping[] getPermissionMappings() {
		return permissionMappings;
	}
	 ...
	 */
	public void setPermissionMappings(com.atlassian.theplugin.commons.jira.api.soap.axis.RemotePermissionMapping[] permissionMappings) {
		this.permissionMappings = permissionMappings;
	}
