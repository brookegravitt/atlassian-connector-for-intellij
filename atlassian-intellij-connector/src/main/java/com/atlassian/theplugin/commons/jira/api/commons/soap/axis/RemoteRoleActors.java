...
public class RemoteRoleActors implements java.io.Serializable {
	private com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteProjectRole projectRole;

	private com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteRoleActor[] roleActors;

	private com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteUser[] users;

	public RemoteRoleActors() {
	}

	public RemoteRoleActors(
			com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteProjectRole projectRole,
			com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteRoleActor[] roleActors,
			com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteUser[] users) {
	 ...
	 * @return projectRole
	 */
	public com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteProjectRole getProjectRole() {
		return projectRole;
	}
	 ...
	 * @param projectRole
	 */
	public void setProjectRole(com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteProjectRole projectRole) {
		this.projectRole = projectRole;
	}
	 ...
	 * @return roleActors
	 */
	public com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteRoleActor[] getRoleActors() {
		return roleActors;
	}
	 ...
	 * @param roleActors
	 */
	public void setRoleActors(com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteRoleActor[] roleActors) {
		this.roleActors = roleActors;
	}
	 ...
	 * @return users
	 */
	public com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteUser[] getUsers() {
		return users;
	}
	 ...
	 * @param users
	 */
	public void setUsers(com.atlassian.theplugin.commons.jira.api.commons.soap.axis.RemoteUser[] users) {
		this.users = users;
	}
