...
public class RemoteRoleActors  implements java.io.Serializable {
    private com.atlassian.theplugin.jira.api.soap.axisv4.RemoteProjectRole projectRole;

    private com.atlassian.theplugin.jira.api.soap.axisv4.RemoteRoleActor[] roleActors;

    private com.atlassian.theplugin.jira.api.soap.axisv4.RemoteUser[] users;

    public RemoteRoleActors() {
    }

    public RemoteRoleActors(
           com.atlassian.theplugin.jira.api.soap.axisv4.RemoteProjectRole projectRole,
           com.atlassian.theplugin.jira.api.soap.axisv4.RemoteRoleActor[] roleActors,
           com.atlassian.theplugin.jira.api.soap.axisv4.RemoteUser[] users) {
     ...
     * @return projectRole
     */
    public com.atlassian.theplugin.jira.api.soap.axisv4.RemoteProjectRole getProjectRole() {
        return projectRole;
    }
     ...
     * @param projectRole
     */
    public void setProjectRole(com.atlassian.theplugin.jira.api.soap.axisv4.RemoteProjectRole projectRole) {
        this.projectRole = projectRole;
    }
     ...
     * @return roleActors
     */
    public com.atlassian.theplugin.jira.api.soap.axisv4.RemoteRoleActor[] getRoleActors() {
        return roleActors;
    }
     ...
     * @param roleActors
     */
    public void setRoleActors(com.atlassian.theplugin.jira.api.soap.axisv4.RemoteRoleActor[] roleActors) {
        this.roleActors = roleActors;
    }
     ...
     * @return users
     */
    public com.atlassian.theplugin.jira.api.soap.axisv4.RemoteUser[] getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(com.atlassian.theplugin.jira.api.soap.axisv4.RemoteUser[] users) {
        this.users = users;
    }
