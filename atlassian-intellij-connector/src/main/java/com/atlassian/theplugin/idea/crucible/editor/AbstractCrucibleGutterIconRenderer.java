...
public abstract class AbstractCrucibleGutterIconRenderer extends GutterIconRenderer {
	...
	private static String getPadding(int indentation) {
    ...
    private static void renderCommentBody(StringBuilder s, Comment cmt, int indentation) {
        boolean boldify =
...
/*	@Override
    ...
    public boolean equals(Object o) {
        ...
        AbstractCrucibleGutterIconRenderer that = (AbstractCrucibleGutterIconRenderer) o;
