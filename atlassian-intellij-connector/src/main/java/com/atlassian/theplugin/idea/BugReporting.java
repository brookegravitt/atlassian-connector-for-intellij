...
public final class BugReporting {
	...
	static {
        ...
        versionMap.put("2.4.2", "12135");
        versionMap.put("2.5.0", "12038");
        versionMap.put("2.5.1", "12167");
		versionMap.put("3.0.0", "12235");
		versionMap.put("3.0.1", "12321");
		versionMap.put("3.0.2", "13191");
        ...
        versionMap.put("3.0.8", "17185");
        versionMap.put("3.0.9", "17184");
        versionMap.put("3.0.10", "20339");
        versionMap.put("3.0.11", "20340");
        versionMap.put("3.0.12", "23183");
        versionMap.put("3.0.13", "25094");
        versionMap.put("3.0.14", "26882");
        versionMap.put("3.0.15", "42382");
    }
