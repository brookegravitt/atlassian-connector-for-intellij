...
public class BambooServerConfigForm extends JComponent implements ServerPanel {
	...
	public ServerBean getData() {
		ServerBean server = genericServerConfigForm.getData();
	...
	private void createUIComponents() {
		...
		planList = new BambooPlansForm(bambooServerFacade);
	}
	...
	private void $$$setupUI$$$() {
		...
		panel1.add(genericServerConfigForm.$$$getRootComponent$$$(), new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
