...
public class IssueCommentTreeMouseListener extends MouseAdapter implements MouseMotionListener, ComponentListener {
	public IssueCommentTreeMouseListener(@NotNull JTree jtree, final IssueCommentRenderer renderer, TreeUISetup treeUISetup) {
		this.jtree = jtree;
	...
	private IssueCommentRenderer renderer;
	...
	public void mouseClicked(final MouseEvent e) {
		if (isMoreLessLinkHit(e)) {
			...
			if (treepath != null) {
				final Object o = treepath.getLastPathComponent();
				if (o instanceof IssueCommentTreeNode) {
					IssueCommentTreeNode commentTreeNode = (IssueCommentTreeNode) o;
