...
//reporterComboBox.addItem(new JIRAReporterBean((long) -1, "No reporter", "issue_no_reporter"));
	...
	private void $$$setupUI$$$() {
		...
		rootPanel.add(componentsVersionsPanel, cc.xy(1, 5));
		fixForScrollPane = new JScrollPane();
		componentsVersionsPanel.add(fixForScrollPane, cc.xy(3, 1));
		fixForList = new JList();
		fixForList.setMinimumSize(new Dimension(250, 0));
		fixForList.setPreferredSize(new Dimension(250, 0));
		...
		componentsList.setMinimumSize(new Dimension(250, 0));
		final DefaultListModel defaultListModel1 = new DefaultListModel();
		componentsList.setModel(defaultListModel1);
		componentsList.setPreferredSize(new Dimension(250, 0));
		...
		affectsVersionsList.setMinimumSize(new Dimension(250, 0));
		final DefaultListModel defaultListModel2 = new DefaultListModel();
		affectsVersionsList.setModel(defaultListModel2);
		affectsVersionsList.setPreferredSize(new Dimension(250, 0));
		...
		rootPanel.add(issueAttributesPanel, new CellConstraints(1, 9, 1, 1, CellConstraints.DEFAULT, CellConstraints.DEFAULT, new Insets(0, 0, 5, 0)));
		...
		prioritiesList.setMinimumSize(new Dimension(250, 0));
		prioritiesList.setPreferredSize(new Dimension(250, 0));
		...
		generalPanel.setLayout(new FormLayout("fill:72px:noGrow,left:4dlu:noGrow,fill:d:grow", "center:d:grow,top:3dlu:noGrow,center:d:grow"));
