...
public interface RpcReviewServiceName {
    ...
    @WebMethod
    public java.util.List<java.lang.Object> getChildReviews(
    ...
    @WebMethod
    public java.util.List<java.lang.Object> getAllReviews(
        @WebParam(name = "token", targetNamespace = "")
        java.lang.String token
    );
    ...
    @WebMethod
    public java.util.List<java.lang.Object> getReviewers(
        @WebParam(name = "token", targetNamespace = "")
        java.lang.String token,
        @WebParam(name = "arg1", targetNamespace = "")
        com.atlassian.theplugin.crucible.api.soap.xfire.review.PermId arg1
    ...
    @WebMethod
    public java.util.List<java.lang.Object> getReviewsInStates(
        @WebParam(name = "token", targetNamespace = "")
        java.lang.String token,
        @WebParam(name = "arg1", targetNamespace = "")
