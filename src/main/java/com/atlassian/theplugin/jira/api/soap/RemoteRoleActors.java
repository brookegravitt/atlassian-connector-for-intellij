...
public class RemoteRoleActors  implements java.io.Serializable {
    private com.atlassian.theplugin.jira.api.soap.RemoteProjectRole projectRole;

    private com.atlassian.theplugin.jira.api.soap.RemoteRoleActor[] roleActors;

    private com.atlassian.theplugin.jira.api.soap.RemoteUser[] users;

    public RemoteRoleActors() {
    }

    public RemoteRoleActors(
           com.atlassian.theplugin.jira.api.soap.RemoteProjectRole projectRole,
           com.atlassian.theplugin.jira.api.soap.RemoteRoleActor[] roleActors,
           com.atlassian.theplugin.jira.api.soap.RemoteUser[] users) {
     ...
     * @return projectRole
     */
    public com.atlassian.theplugin.jira.api.soap.RemoteProjectRole getProjectRole() {
        return projectRole;
    }
     ...
     * @param projectRole
     */
    public void setProjectRole(com.atlassian.theplugin.jira.api.soap.RemoteProjectRole projectRole) {
        this.projectRole = projectRole;
    }
     ...
     * @return roleActors
     */
    public com.atlassian.theplugin.jira.api.soap.RemoteRoleActor[] getRoleActors() {
        return roleActors;
    }
     ...
     * @param roleActors
     */
    public void setRoleActors(com.atlassian.theplugin.jira.api.soap.RemoteRoleActor[] roleActors) {
        this.roleActors = roleActors;
    }
     ...
     * @return users
     */
    public com.atlassian.theplugin.jira.api.soap.RemoteUser[] getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(com.atlassian.theplugin.jira.api.soap.RemoteUser[] users) {
        this.users = users;
    }
