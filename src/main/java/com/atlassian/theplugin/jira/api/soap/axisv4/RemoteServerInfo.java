...
public class RemoteServerInfo  implements java.io.Serializable {
    ...
    private com.atlassian.theplugin.jira.api.soap.axisv4.RemoteTimeInfo serverTime;
    ...
    public RemoteServerInfo(
           ...
           com.atlassian.theplugin.jira.api.soap.axisv4.RemoteTimeInfo serverTime,
     ...
     * @return serverTime
     */
    public com.atlassian.theplugin.jira.api.soap.axisv4.RemoteTimeInfo getServerTime() {
        return serverTime;
    }
     ...
     * @param serverTime
     */
    public void setServerTime(com.atlassian.theplugin.jira.api.soap.axisv4.RemoteTimeInfo serverTime) {
        this.serverTime = serverTime;
    }
