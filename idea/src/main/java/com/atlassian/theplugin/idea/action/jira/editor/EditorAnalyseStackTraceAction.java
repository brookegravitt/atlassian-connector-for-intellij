...
public class EditorAnalyseStackTraceAction extends AnAction {
	...
	public void update(AnActionEvent event) {
		ThePluginJIRAEditorComponent.JIRAFileEditor editor =
				ThePluginJIRAEditorComponent.getEditorByKey(event.getPlace());
		if (editor != null) {
			event.getPresentation().setEnabled(editor.hasStackTraceInDescription());
		}
		super.update(event);
	}
}
